...
export class IndexUserComponent {
  ...
  private readonly userService = inject(UserService); // 🔹 Servicio de usuarios
  private readonly authService = inject(AuthService); // 🔹 Servicio de autenticación
  ...
  /**
   * Elimina un usuario con confirmación visual
