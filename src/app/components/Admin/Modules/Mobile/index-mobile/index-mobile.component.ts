/** Componente principal para listar y gestionar móviles */
import {
...
export class IndexMobileComponent {
  ...
  // Recurso reactivo para obtener datos de móviles desde el backend
  public readonly mobileResource = rxResource<
    Mobile[],
  ...
  >({
    ...
    loader: ({ request }) => this.loadMobilesData(request),
  });
  ...
  /** Elimina un móvil con confirmación previa */
  ...
  // Carga los móviles desde el backend y actualiza metadatos de paginación
  private loadMobilesData(request: {
    query: string;
    page: number;
    show: number;
  }) {
  ...
  // Muestra confirmación antes de eliminar un móvil
