...
export class IndexMobileComponent {
  ...
  private readonly mobileService = inject(MobileService); // 🔹 Servicio de móviles
  ...
  /**
   * Elimina un móvil con confirmación visual
   * @param id - ID del móvil a eliminar
   */
  ...
  /**
   * Carga los datos de móviles desde el servicio
