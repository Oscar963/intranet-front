            ...
            <div class="container-fluid">
                <div class="row g-2 align-items-center">
                    <div class="col"><!-- Page pre-title -->
                        ...
                        <h2 class="page-title">Actualizar Popup</h2>
                    </div>
                </div>
            </div>
        </div>
...
const submit = async () => {
    ...
    try {
        const response = await axiosInstance.post(`/api/popups/${id}`, formData, {
...
const loadData = async () => {
    loadingSubmit.value = true;
    try {
        const response = await axiosInstance.get(`/api/popups/${id}`);
