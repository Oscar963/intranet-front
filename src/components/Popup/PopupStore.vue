            ...
            <div class="container-fluid">
                <div class="row g-2 align-items-center">
                    <div class="col"><!-- Page pre-title -->
                        ...
                        <h2 class="page-title">Registar Popup</h2>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h3 class="card-title">Datos del popup</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label class="form-label required">Imagen Popup</label>
                                            <DropzoneImg1 ref="dropzoneComponentPopup" />
                                            <!-- Mostrar mensaje de error si existe -->
...
const title = ref("");
const status = ref("");
const date_expiration = ref(moment().format('DD-MM-YYYY HH:mm:ss'));
const dropzoneComponentPopup = ref(null);
...
const loadPage = () => {
    title.value = "";
    status.value = "";
    date_expiration.value = new Date();
    clearErrors();
    dropzoneComponentPopup.value.removeAllFiles();
};
...
const submit = async () => {
    ...
    const image = dropzoneComponentPopup.value.getFile();
    if (image) {
    ...
    try {
        const response = await axiosInstance.post("/api/popups", formData, {
